(function() {
            ...
            const faviconHref = document.querySelector('link[rel="icon"]')?.getAttribute('href') || 'assets/images/kd-logo-favicon.svg';
            const imageBasePath = faviconHref.slice(0, faviconHref.lastIndexOf('/') + 1);
            ...
            const projetos = [ 
                ...
                tag: 'Sistema', imagem: 'portfolio-estoque-fortart.png', url: 'https://contatokaleomiranda-netizen.github.io/Estoque-da-papelaria/' }, 
                ...
                { id: 2, titulo: 'Pousada Estrela da Manhã', descricao: 'Site institucional para apresentar a pousada, destacar seus espaços e direcionar reservas pelo WhatsApp.', 
                    ...
                    categoria: 'sites', icone: '🏡', techs: ['Site institucional', 'Responsivo', 'WhatsApp'], tag: 'Site', imagem: 'portfolio-pousada.png', url: 'https://contatokaleomiranda-netizen.github.io/Pousada-Estrela-da-Manh-/' }, 
                ...
                tag: 'Site', imagem: 'portfolio-mayle-store.png', url: 'https://contatokaleomiranda-netizen.github.io/mayle-store/' }, 
                ...
                { id: 4, titulo: 'Fort.Art Papelaria e Presentes', descricao: 'Site para papelaria com apresentação da marca, produtos criativos e chamada para visita/contato.', 
                    ...
                    categoria: 'sites', icone: '✏️', techs: ['Site institucional', 'Papelaria', 'Responsivo'], tag: 'Site', imagem: 'portfolio-fortart.png', url: 'https://fortart.com.br/' },
                ...
                setTimeout(function() { 
                    ...
                    portfolioGrid.innerHTML = filtrados.map(function(p) { 
                        ...
                        return '<div class="project-card reveal" data-3d>' + 
                            ...
                            '<div class="project-card__img"><img class="project-card__shot" src="' + imageBasePath + p.imagem + '" alt="Prévia do projeto ' + p.titulo + '" loading="lazy"><span class="project-card__tag">' + p 
